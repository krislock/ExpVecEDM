...
* form Q using the upper triangular part
**********************************************************/
void symcmp(double *Q, double *QI, mwSize n)
{
   int j, k, jn, kn; 
...
void smat1(mwSize n, const double ir2, 
           const double *A, const mwIndex *irA, const mwIndex *jcA, mwSize isspA, 
...
* multiple sub-blocks 
**********************************************************/
void smat2(mwSize n, const mwSize numblk, const mwIndex *cumblksize, const mwIndex *blknnz, 
           const double ir2, 
           const double *A, const mwIndex *irA, const mwIndex *jcA, mwSize isspA, 
           mwSize mA, mwSize colidx, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB)
...
* single block 
**********************************************************/
void smat1cmp(mwSize n, const double ir2, 
           const double *A, const mwIndex *irA, const mwIndex *jcA, mwSize isspA, 
           mwSize mA, mwSize colidx, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB,
           double *AI, double *BI)
...
* multiple sub-blocks 
**********************************************************/
void smat2cmp(mwSize n, const mwSize numblk, const mwIndex *cumblksize, const mwIndex *blknnz, 
           const double ir2, 
           const double *A, const mwIndex *irA, const mwIndex *jcA, mwSize isspA, 
           mwSize mA, mwSize colidx, 
           double *B, mwIndex *irB, mwIndex *jcB, mwSize isspB,
...
{    mxArray  *rhs[2]; 
     ...
     mwSize    mblk, mA, nA, m1, n1, rowidx, colidx, isspA, isspB;
     mwSize    iscellA, iscmpA; 
